...
public class CustomerChatAdapter extends ArrayAdapter<String> {
    private final Context context;
    private List<String> chatNames;
    private List<String> chatDescriptions;
    private List<String> chatDates;
    public CustomerChatAdapter(@NonNull Context context, int resource, List<String> chatNames, ArrayList<String> chatDescriptionList, ArrayList<String> chatDatesList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(getRandomNumber()<2){
            chatDateText.setTextColor(context.getColor(R.color.accent));
